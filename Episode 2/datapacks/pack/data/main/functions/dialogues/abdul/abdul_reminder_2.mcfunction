# Made by EOSand
# Abdul dialogue to remind P of quest items

# Remove comparator
execute if score @p Timer matches 0 run setblock -1953 81 917 minecraft:bricks

execute if score @p Timer matches 0 run tellraw @p ["",{"text":"ABDUL ›››","color":"green","bold":true},{"text":" Remember, I need a","color":"gray"},{"text":" Mending Book","color":"yellow"},{"text":" and","color":"gray"},{"text":" 16 Lapis Lazuli","color":"blue"},{"text":" for the hint!","color":"gray"}]
